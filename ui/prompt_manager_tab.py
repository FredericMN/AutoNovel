...
class PromptManagerTab(ctk.CTkFrame):
    ...
    VARIABLE_DESCRIPTIONS = {
        ...
        "volume_display": "卷展示信息（如第几卷/卷名）",
        "volume_position": "章节在本卷中的位置（开局/发展/高潮/收束）",
        "chapter_number": "当前章节号",
        "chapter_title": "章节标题",
        "chapter_outline": "章节大纲",
        "chapter_role": "章节定位（功能定位）",
        "chapter_purpose": "章节核心作用（推进目标）",
        "suspense_level": "悬念密度要求",
        "foreshadowing": "伏笔设计要求",
        "plot_twist_level": "转折/认知颠覆强度要求",
        "chapter_summary": "章节简述（目录/蓝图中的摘要）",
        "characters_involved": "可用人物/出场角色提示",
        "key_items": "可用关键道具提示",
        "scene_location": "场景地点/空间坐标提示",
        "time_constraint": "时间压力/倒计时约束提示",
        "novel_setting": "小说设定（世界观/基调/规则）",
        ...
        "unresolved_plot_arcs": "未解决的伏笔/悬念（从 plot_arcs.txt 提取并注入章节提示词）",
        "volume_info": "分卷信息（卷号、卷摘要、当前卷摘要等）",
        "previous_chapter_excerpt": "前章结尾段摘录/原文",
        "short_summary": "最近章节的短摘要（用于承接）",
        "current_volume_display": "当前章节所属卷展示信息",
        "next_volume_display": "下一章节所属卷展示信息",
        "next_chapter_number": "下一章章节号",
        "next_chapter_title": "下一章标题",
        "next_chapter_role": "下一章章节定位",
        "next_chapter_purpose": "下一章核心作用",
        "next_chapter_suspense_level": "下一章悬念密度要求",
        "next_chapter_foreshadowing": "下一章伏笔设计要求",
        "next_chapter_plot_twist_level": "下一章转折/颠覆强度要求",
        "next_chapter_summary": "下一章简述（目录/蓝图中的摘要）",
        "filtered_context": "知识库过滤后的参考上下文",
        "critique": "编辑的批评意见（Plan C）",
        "draft_text": "章节初稿正文（Plan C）"
    }
