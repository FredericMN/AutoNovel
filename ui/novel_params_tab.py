...
def build_novel_params_area(self, start_row=1):
    ...
    num_chapters_entry = ctk.CTkEntry(chapter_word_frame, textvariable=self.num_chapters_var, width=55, font=("Microsoft YaHei", 12))
    num_chapters_entry.grid(row=0, column=1, padx=3, pady=3, sticky="w")
    ...
    self.num_volumes_entry = ctk.CTkEntry(chapter_word_frame, textvariable=self.num_volumes_var, width=55, font=("Microsoft YaHei", 12))
    self.num_volumes_entry.grid(row=0, column=5, padx=3, pady=3, sticky="w")
